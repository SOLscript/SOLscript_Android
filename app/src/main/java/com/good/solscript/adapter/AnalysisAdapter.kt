...
class AnalysisAdapter : RecyclerView.Adapter<AnalysisAdapter.SelectedViewHolder>() {
    ...
    class SelectedViewHolder(val binding : RecyclerAnaysisItemBinding) : RecyclerView.ViewHolder(binding.root)

    var data = listOf<AnalysisData>()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SelectedViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.recycler_anaysis_item,parent,false)
