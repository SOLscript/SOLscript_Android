...
class CategoryViewPagerAdapter(fm: FragmentManager) :
    ...
    private val categoryTitleList =
        listOf("엔터테인", "생필품", "식품", "반려동물", "유아동", "디지털", "취미/도서", "홈데코", "패션의류")

    private val categoryList =
        listOf("entertain", "life", "food", "animal", "kid", "digital", "hobby", "home", "passion")
    ...
    override fun getPageTitle(position: Int): CharSequence? = categoryTitleList[position]
}
